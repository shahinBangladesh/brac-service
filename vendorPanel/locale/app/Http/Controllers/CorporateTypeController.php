...
class CorporateTypeController extends Controller
{
    ...
    public function corporateIndex()
    {
        ...
        return view('corporate.serviceType.index',compact('title','getData'));
    }
    ...
    public function corporateCreate()
    {
        ...
        $create = 1;
        return view('corporate.serviceType.form',compact('title','create'));
    }
    ...
    public function corporateStore(Request $request)
    {
        ...
        Session::flash('message','Successfully Created');
        return redirect()->route('corporate.serviceType.index');
    }
    ...
    public function corporateEdit($id)
    {
        ...
        return view('corporate.serviceType.form',$data);
    }
