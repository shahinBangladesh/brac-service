...
class BranchController extends Controller
{
    ...
    public function corporateIndex()
    {
        ...
        if($corporate[0]->branch_id == null){
            ...
            return view('corporate.branch.index',compact('title','getData'));
        }else{
    ...
    public function corporateCreate()
    {
        ...
        if($corporate[0]->branch_id == null){
            $title = 'branch Create';
            $create = 1;
            return view('corporate.branch.form',compact('title','create'));
        }else{
            return redirect()->route('corporate.dashboard');
        }
    }
    ...
    public function corporateStore(Request $request)
    {
        ...
        Session::flash('message','Successfully Created');
        return redirect()->route('corporate.branch.index');
    }
    ...
    public function corporateEdit(branch $id)
    {
        ...
        $data['organization'] = Organization::where('status',1)->get();
        return view('corporate.branch.form',$data);
    }
