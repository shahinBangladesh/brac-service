...
class CorporateController extends Controller
{
    ...
    {
        $corporate = Corporate::where('id',Auth()->id())->get();
    ...
    public function approveAction($jobReqId){
        ...
        if($corporate[0]->branch_id == null){
            $data['approverList'] = Corporate::where('approverOrConsent',1)->where('id','!=',Auth()->user()->id)->get();
            ...
            if($data['accessOrNot']!=0){
                ...
                $data['approverAccessOrNot'] = ApproverPath::where('forward_user',Auth()->user()->id)->where('id',$approvePath[0]->id)->count();
            }
            // dd($data);
    ...
    public function estimateAction($jobReqId){
        ...
        if($corporate[0]->branch_id == null){
            ...
            if($data['accessOrNot']!=0){
                ...
                $data['approverAccessOrNot'] = EstimateApprover::where('forward_user',Auth()->user()->id)->where('id',$approvePath[0]->id)->count();
            }
