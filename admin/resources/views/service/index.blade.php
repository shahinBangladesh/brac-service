...
@include('layouts.messege')  
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <a href="{{ route('service.create') }}" class="btn btn-primary" style="margin-bottom: 15px;">Add New</a>
      <ol class="breadcrumb">
                        ...
                        <div class="btn-group">
                          <div class="dropdown">
                            ...
                            <ul role="menu" class="dropdown-menu">
                              <li><a href="{{ route('service.edit',$value->id) }}">Edit</a></li>
                              {{-- @if(Auth::guard('corporate')->user()->approverOrConsent == 1)
                              <li>
                                  {{ Form::open(['method'=>'delete','route'=>['service.destroy',$value->id]]) }}
